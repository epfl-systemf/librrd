...
// CSS-like text-box-edge/trim, with two deviations: an additional `ink` value
// to match the text's ink box, and a separate `align` property to decide where
// to place the baseline in the box.
